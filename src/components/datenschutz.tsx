        ...
        <div className="bg-zinc-900 text-white py-16 min-h-screen">
            <div className="max-w-[900px] mx-auto px-4">
                ...
                <section className="mb-8">
                    ...
                    <p className="mt-3">
                        {language === "de" ? "Sie können Ihre Cookie-Einstellungen jederzeit ändern, indem Sie den Cookie-Banner erneut über den Link im Footer aufrufen oder Ihre Browser-Einstellungen anpassen. Ihre aktuelle Consent-ID finden Sie direkt in den Cookie-Einstellungen." : "You can change your cookie settings at any time by calling up the cookie banner again via the link in the footer or by adjusting your browser settings. You can find your current Consent ID directly in the cookie settings."}
                    </p>
                ...
                <section className="mb-8">
                    ...
                    <ul className="list-disc pl-5 mt-2.5">
                        ...
                        <li><strong>Stripe</strong>: {language === "de" ? "Zur Abwicklung von Zahlungen (z.B. Gutscheinkauf). Stripe verarbeitet Zahlungs- und Kontaktinformationen sowie technische Daten zur Betrugsprävention." : "For processing payments (e.g. voucher purchase). Stripe processes payment and contact information as well as technical data for fraud prevention."}</li>
                        <li><strong>Kontaktformular / E-Mail</strong>: {language === "de" ? "Wenn Sie uns Anfragen zukommen lassen, werden Ihre Angaben aus dem Anfrageformular inklusive der von Ihnen dort angegebenen Kontaktdaten zwecks Bearbeitung der Anfrage und für den Fall von Anschlussfragen bei uns gespeichert." : "If you send us inquiries, your details from the inquiry form, including the contact data you provided there, will be stored by us for the purpose of processing the inquiry and in case of follow-up questions."}</li>
                    </ul>
                </section>
